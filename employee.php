...
elseif(isset($_SESSION['email']) && $_session['role'] = 'employee'){
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control" name="booking_status" required>
                                    ...
                                    <option value="car1">Confirmed</option>
                                    <option value="car2">Pending</option>
                                    <option value="car2">Canceled</option>
                                </select>
                ...
                <div class="modal-footer">
                    ...
                    <a href="admin.php"><input class="btn btn-primary" type="submit" Name="btnaddbooking" value="Submit"></a>
                </div>
            </div>
        </div>
    </div>
